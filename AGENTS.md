...
10. v46 起 RTH 铁鹰只在 10:00–11:30 ET 枚举当日第一个合格人工候选：固定 20Δ 短腿、10 点两侧翼，exact 四腿 BBO age ≤15 秒/source skew ≤2 秒，贷记占翼宽 15%–55%，定义风险 ≤$1,000。回购价 ≤0.5C 止盈、≥3C 止损（净亏 200%）、15:45 ET 硬退；每 RTH session 最多一张，GTH 继续 map-only，`automatic_ordering=false`。
