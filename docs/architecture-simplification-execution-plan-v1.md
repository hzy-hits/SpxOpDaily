...
| 2026-08-08 | production safety: Core transient Globex skip | +0 / -0 | production +12 / -2（net +10） | +0 / -0 | +0 / -0 | +0 / -0 | +0 / -0 | `no_fresh_direct_es` 继续 fail-closed 且 CLI 默认仍非零；仅 Core 内嵌周期将该已知跳过映射为非致命，真实异常与其他非零仍触发 systemd 重启；29 tests、Ruff、Import Linter、diff-check PASS，Oracle 新 activation 验收待完成 |
