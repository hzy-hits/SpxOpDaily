...
def test_gth_trend_quality_allows_dip_inside_supportive_macro() -> None:
    result = _gth_trend_entry_quality(
        {
            "session_id": "2026-07-14:gth",
            "updated_at": (NOW - timedelta(seconds=30)).isoformat(),
...
def test_gth_trend_quality_blocks_bearish_macro_even_after_short_bounce() -> None:
    result = _gth_trend_entry_quality(
        {
            "session_id": "2026-07-14:gth",
