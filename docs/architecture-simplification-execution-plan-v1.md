...
| 2026-08-08 | production safety: front-chain observation clock | +0 / -0 | production +13 / -11（net +2） | +0 / -0 | +0 / -0 | +0 / -0 | +0 / -0 | RTH readiness 复用既有 analytical observation/entitlement 合同，删除“交易所价格 15 秒内必须变化”的重复门；真实 transport、entitlement、BBO 与链结构门不变；71 tests、Ruff、Import Linter、diff-check PASS，Oracle 验收待完成 |
