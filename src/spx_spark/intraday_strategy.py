...
class IntradayStrategySettings:
    ...
    def from_env(cls) -> "IntradayStrategySettings":
        return cls(
            level_buffer_points=env_float("ALERT_INTRADAY_CALL_LEVEL_BUFFER_POINTS", 3.0),
            confirm_samples=env_int("ALERT_INTRADAY_CALL_CONFIRM_SAMPLES", 2),
            confirm_window_seconds=env_int("ALERT_INTRADAY_CALL_CONFIRM_WINDOW_SECONDS", 60),
            source_event_ttl_seconds=env_int("ALERT_INTRADAY_CALL_SOURCE_TTL_SECONDS", 300),
            bias_ttl_seconds=env_int("ALERT_INTRADAY_CALL_BIAS_TTL_SECONDS", 300),
            cooldown_seconds=env_int("ALERT_INTRADAY_CALL_COOLDOWN_SECONDS", 900),
            structure_grace_seconds=env_int("ALERT_INTRADAY_CALL_STRUCTURE_GRACE_SECONDS", 30),
            retry_seconds=env_int("ALERT_INTRADAY_CALL_RETRY_SECONDS", 30),
            level_drift_tolerance_points=env_float(
                "ALERT_INTRADAY_CALL_LEVEL_DRIFT_TOLERANCE_POINTS", 5.0
            ),
            es_confirm_ratio=env_float("ALERT_INTRADAY_CALL_ES_CONFIRM_RATIO", 0.50),
            es_hold_tolerance_bps=env_float("ALERT_INTRADAY_CALL_ES_HOLD_TOLERANCE_BPS", 1.0),
        )
