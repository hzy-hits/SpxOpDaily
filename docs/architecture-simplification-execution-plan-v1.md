...
| 2026-08-07 | P5-1/S6 implementation | +2 / -0 | production +548 / -5 | +0 / -0 | +0 / -0 | +0 / -0 | +7 / -0 | Alembic `0002` 追加七张 operational 表；live StrategyDecision 与 legs 原子写 SQL 后才导出/入 READY；replay 改读 SQL；2949 tests、Ruff、import contracts PASS；旧 research ledger 删除与 Oracle 周末 cutover 待完成，未标记 P5/S6 完成 |
