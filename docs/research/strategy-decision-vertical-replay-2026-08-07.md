# Strategy Decision v2 · S2 Vertical Replay · 2026-08-07

状态：**Bootstrap evidence；不得表述为已验证 edge，不切换生产候选 owner。**
...
4. 2026-08-05 与 2026-08-06 的完整 frozen case 包含 Pin Butterfly，必须由 S3 完成。
...
| 2026-08-05 frozen case | PENDING S3 |
| 2026-08-06 frozen case | PENDING S3 |

结论：`bootstrap_gate=collecting`。S2 代码可进入下一张任务卡，但旧 Vertical/GTH green-card 的人类最终授权不得切换；待 S3 frozen cases 通过后重新裁决。
