...
def humanize_strategy_reason(reason: str) -> str:
    ...
    exact = {
        ...
        "iron_condor_surface_gate_unavailable": "铁鹰入场ATM IV或smile数据不可用",
        "iron_condor_session_surface_blocked": "铁鹰当天首个合格候选未通过IV/smile门，本RTH不再开仓",
        "iron_condor_session_candidate_locked": "铁鹰当天首个合格行权价已锁定，不随盘中Delta迁移换腿",
        "iron_condor_atm_iv_high": "铁鹰入场ATM IV超过冻结风险上限",
        "iron_condor_smile_richness_high": "铁鹰入场smile曲率超过冻结风险上限",
        ...
        "butterfly_look_mass_not_concentrated": "午盘蝶要求质量堆在中轴 ±翼宽内",
        "butterfly_five_wide_look_mass_not_concentrated": "午盘蝶要求质量堆在中轴 ±翼宽内",
